  ...
  return show? (
    <div className='px-6 md:px-16 lg:px-40 ot-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            <button className='flex items-centre gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-900 transition rounded-md font-medium cursor-pointer active:scale-95'>
              <PlayCircle className='w-5 h-5'/>
              Watch Trailer</button>
            <a href="#dateSelect" className='px-10 py-3 tex-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer active:scale-95'>Buy Tickets</a>
      ...
      <div className='overflow-x-auto no-scrollbar mt-8 pb-4'>
        <div className='flex items-centre gap-4 w-max px-4'>
