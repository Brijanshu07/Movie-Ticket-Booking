...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    ...
    <div className='overflow-x-auto pb-4'>
      <div className='group flex flex-wrap gap-4 mt-4 w-max'>
        {nowPlayingMovies.map((movie) => (
          <div key={movie.id} onClick={()=> setSelectedMovie(movie.id)} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover-translate-y-1 duration-300`} >
    ...
    <button onClick={handleSubmit} disabled={addingShows} className='bg-primary px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer'>
      Add Show
    </button>
